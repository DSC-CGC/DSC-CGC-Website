    ...
    <v-row align="center" justify="center">
      <v-col cols="12" md="3" lg="3" sm="4" class>
        ...
        <p
          ...
          style="font-size:95%"
        >This Club provides the platform to the students for many technical related problems and assist them to build Web Technologies, Machine Learning, Mobile App Development and Cloud skills.

Tap on the below given icons and start learning now!</p>
